...
const softwareProblems = [
  {
    ...
    description: "Diagnose and fix Windows system crashes and stop errors",
    icon: Monitor,
    severity: "critical",
    estimatedTime: "30-90 min",
    difficulty: "intermediate",
    steps: [
      "Note the stop code from BSOD",
      "Boot into Safe Mode",
    ...
    image: softwareDiagnosticsImage,
    youtubeId: "QGr0EoI0eag"
  },
  {
    id: 2,
    title: "Slow System Performance",
    description: "Optimize Windows for better speed and responsiveness",
    icon: RefreshCw,
    severity: "medium",
    ...
    image: softwareDiagnosticsImage,
    youtubeId: "IU5F01oOzQQ"
  },
  {
    id: 3,
    title: "Application Crashes",
    description: "Fix programs that freeze, crash, or won't start properly",
    icon: Bug,
    severity: "medium",
    ...
    image: softwareDiagnosticsImage,
    youtubeId: "0SiUOZ_NKjo"
  },
  {
    id: 4,
    title: "Driver Issues",
    description: "Update, reinstall, or troubleshoot device drivers",
    icon: Settings,
    severity: "high",
    ...
    steps: [
      ...
      "Install new drivers",
      "Restart computer and test functionality"
    ],
    image: softwareDiagnosticsImage,
    youtubeId: "M9SScIGTOo4"
  }
];

const SoftwarePage = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [filteredProblems, setFilteredProblems] = useState(softwareProblems);
  const [selectedProblem, setSelectedProblem] = useState(null);

  useEffect(() => {
    const filtered = softwareProblems.filter(problem =>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            <div>
              ...
              <p className="text-xl text-foreground/80 mb-8">
                Fix Windows errors, application crashes, and system performance issues. 
                Expert troubleshooting guides for all software problems.
              </p>
            ...
            <div className="relative">
              <img 
                src={softwareDiagnosticsImage} 
                alt="Software Diagnostics" 
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-md mx-auto relative">
            ...
            <Input
              placeholder="Search software problems..."
              value={searchTerm}
